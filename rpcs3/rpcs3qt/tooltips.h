...
public:
	...
	const struct settings
	{
		...
		const QString enable_thread_scheduler   = tr("Attempt to reduce desync by upping the thread priority.\nPPU + SPU is recommended to eliminate audio stutter and desyncs caused by shader compilation.\nPPU + SPU + RSX can eliminate video stutters but is susceptible to RSX desyncs.");
