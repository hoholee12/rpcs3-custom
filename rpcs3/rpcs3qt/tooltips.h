...
public:
	...
	const struct settings
	{
		...
		const QString enable_thread_scheduler   = tr("Attempt to reduce desync by upping the thread priority.\nSPU focused is recommended to eliminate audio stutter and SPU desyncs caused by shader compilation.\nPPU + SPU + RSX can eliminate video stutters but is susceptible to SPU desyncs.");
