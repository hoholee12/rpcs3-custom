...
public:
	...
	const struct settings
	{
		...
		const QString enable_thread_scheduler   = tr("Attempt to reduce desync by changing the thread priority.\n'Change thread priority' puts the recompiler threads on top priority, interrupting all game threads equally, reducing the chance of a desync.\n'Change thread count' does it more forcefully by changing thread counts as well.");
