...
public:
	...
	const struct settings
	{
		...
		const QString enable_thread_scheduler   = tr("Attempt to reduce desync by changing the thread priority.\n'Subtle' only changes recompiler thread priority.\n'Harsh' does it more forcefully by changing the number of recompiler threads.\n'Extreme' pins the threads to specific set of cores. You need at least 6 physical(or 8 virtual) cores on your machine!");
