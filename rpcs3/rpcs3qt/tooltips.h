...
public:
	...
	const struct settings
	{
		...
		const QString enable_thread_scheduler   = tr("Attempt to reduce desync by changing the thread priority.\nAnything other than 'Default' changes the priority of the compiler threads to reduce desync.\n'PPU/SPU>REC/RSX>shader' option is needed for some games that have issues with SPU thread on high priority.");
