...
inline static const QMap<emu_settings_type, cfg_location> settings_location =
{
	...
	{ emu_settings_type::AccurateRSXReservation,   { "Core", "Accurate RSX Reservation"}},
	...
	{ emu_settings_type::SPURSUrgentQueueSize,	   { "Core", "SPURS Urgent Queue Size"}},
	...
	{ emu_settings_type::DisableVulkanFence,		 { "Video", "Disable Vulkan Fence"}},
