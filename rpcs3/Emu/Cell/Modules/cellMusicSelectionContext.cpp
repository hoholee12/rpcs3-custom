...
bool CellMusicSelectionContext::music_selection_context::set(const CellMusicSelectionContext& in)
{
...
CellMusicSelectionContext CellMusicSelectionContext::music_selection_context::get() const
{
...
std::string CellMusicSelectionContext::music_selection_context::to_string() const
{
...
std::string CellMusicSelectionContext::music_selection_context::get_next_hash()
{
	static u64 hash_counter = 0;
	return fmt::format("music_selection_context_%d", hash_counter++);
}

std::string CellMusicSelectionContext::music_selection_context::context_to_hex(const CellMusicSelectionContext& context)
{
	std::string dahex;
...
std::string CellMusicSelectionContext::music_selection_context::get_yaml_path() const
{
...
void CellMusicSelectionContext::music_selection_context::set_playlist(const std::string& path)
{
	playlist.clear();
...
void CellMusicSelectionContext::music_selection_context::create_playlist(const std::string& new_hash)
{
	hash = new_hash;
...
bool CellMusicSelectionContext::music_selection_context::load_playlist()
{
	playlist.clear();
...
u32 CellMusicSelectionContext::music_selection_context::step_track(bool next)
{
	if (playlist.empty())
	{
