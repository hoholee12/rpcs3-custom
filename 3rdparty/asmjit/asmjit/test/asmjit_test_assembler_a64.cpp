...
static void ASMJIT_NOINLINE testA64AssemblerRel(AssemblerTester<a64::Assembler>& tester) noexcept {
  ...
  TEST_INSTRUCTION("00000054", cond_eq().b(L0));
  TEST_INSTRUCTION("01000054", cond_ne().b(L0));
  TEST_INSTRUCTION("02000054", cond_hs().b(L0));
  TEST_INSTRUCTION("03000054", cond_lo().b(L0));
  TEST_INSTRUCTION("04000054", cond_mi().b(L0));
  TEST_INSTRUCTION("05000054", cond_pl().b(L0));
  TEST_INSTRUCTION("06000054", cond_vs().b(L0));
  TEST_INSTRUCTION("07000054", cond_vc().b(L0));
  TEST_INSTRUCTION("08000054", cond_hi().b(L0));
  TEST_INSTRUCTION("09000054", cond_ls().b(L0));
  TEST_INSTRUCTION("0A000054", cond_ge().b(L0));
  TEST_INSTRUCTION("0B000054", cond_lt().b(L0));
  TEST_INSTRUCTION("0C000054", cond_gt().b(L0));
  TEST_INSTRUCTION("0D000054", cond_le().b(L0));
